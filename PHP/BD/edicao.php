    ...
    if(!isset($_POST["raAluno"])){
        ...
        try{    
            ...
            while ($row = $stmt -> fetch()){
                ...
                <select name = 'curso'>\n
                <option></option>\n
                <option value = 'Edificações' $edificacoes>
                Edificações</option> \n
                <option value = 'Enfermagem' $enfermagem>
                Enfermagem</option> \n
                <option value = 'Geodésia' $geodesia>
                Geodésia</option> \n
                <option value = 'Enfermagem' $enfermagem>
                Enfermagem</option> \n
                <option value = 'Informática' $informatica>
                Informatica</option> \n
                <option value = 'Mecânica' $mecanica>
                Mecânica</option> \n
                <option value = 'Qualidade' $qualidade>
                Qualidade</option> \n
                </select><br><br>\n
